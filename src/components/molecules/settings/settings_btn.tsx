...
const Setting_Btn = ({ onClick, is_open }: settings_btn_props) => {
  return (
    <motion.button
      className="px-6 py-4 z-40 rounded-full ease-out-quad duration-200 fixed bottom-2 left-2 md:left-4 md:bottom-4 lg:left-6 lg:bottom-6 bg-gray_dark bg-opacity-75 dark:bg-opacity-75 dark:bg-black_light backdrop-filter backdrop-blur focus-visible:ring-4 ring-main"
      whileHover="hover"
      exit="hidden"
